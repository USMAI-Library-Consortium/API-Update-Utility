...
def custom_xml_update_function(resource_id: str, xml_from_get_request: bytes, update_values: list, xpaths: list[str] | None = None, operations: str | list[str] | None = None) -> bytes | None:
